...
public class WaterRenderer {
    ...
    public WaterRenderer(Loader loader, WaterShader shader, Matrix4f projectionMatrix, WaterFrameBuffer waterFrameBuffer) {
        this.shader = shader;
    ...
    private void prepareRender(Camera camera, Light sun){
        ...
        //TODO check of het mogelijk is om wat van de wereld/skybox hier doorheen te zien
